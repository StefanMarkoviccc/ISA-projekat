...
insert into `user` (`id`, `email`, `password`, `first_name`, `last_name`, `address`, `city`, `country`, `phone_number`, `user_type`, `description`, `registration_status`, `deleted`) values(4, 'admin@gmail.com', '$2a$12$0xHdj9w3Y89PvmDWLRMnd.0Ee2ymOcXD5vGn4OlKHDLHHIXyeVm2a', 'Stefann', 'Markoviccc', 'Milosa Parovica 36', 'Uzice', 'Srbija', '555 333', 'ADMINISTRATOR', 'adminadminadmin', 'APPROVED', 0);
insert into `user` (`id`, `email`, `password`, `first_name`, `last_name`, `address`, `city`, `country`, `phone_number`, `user_type`, `description`, `registration_status`, `deleted`) values(6, 'Jovana@gmail.com', '$2a$12$0xHdj9w3Y89PvmDWLRMnd.0Ee2ymOcXD5vGn4OlKHDLHHIXyeVm2a', 'Jovana', 'Ivanovic', 'Milosa Parovica 36', 'Uzice', 'Srbija', '555 333', 'BOAT_OWNER', 'vlasnik broda', 'APPROVED', 0);
insert into `user` (`id`, `email`, `password`, `first_name`, `last_name`, `address`, `city`, `country`, `phone_number`, `user_type`, `description`, `registration_status`, `deleted`) values(7, 'isaprojekatklient@gmail.com', '$2a$10$vt2iNdLBkgbW54Q89x37vODiWXqp66C2GuCE3y72fgu.UMufeCaKe', 'Marko', 'Markovic', 'Milosa Parovica 36', 'Uzice', 'Srbija', '555 333', 'CLIENT', 'klijent', 'APPROVED', 0);
